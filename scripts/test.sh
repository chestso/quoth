...
echo "=== Byte-compile ==="
for f in quoth.el quoth-provider.el quoth-openai-client.el quoth-context.el quoth-openai-provider.el quoth-hyper-provider.el quoth-ollama-provider.el quoth-tools.el quoth-xxh3.el quoth-process.el quoth-searxng.el quoth-select.el; do
